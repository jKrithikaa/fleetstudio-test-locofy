...
const DesktopLabs = () => {
  return (
    <div className="w-full relative bg-fleet-white overflow-hidden flex flex-col items-start justify-start gap-[87px] leading-[normal] tracking-[normal] mq750:gap-[43px] mq450:gap-[22px]">
      <main className="self-stretch flex flex-col items-start justify-start gap-[55px] max-w-full mq750:gap-[27px]">
        <FrameComponent />
        <section className="self-stretch flex flex-row items-start justify-start py-0 px-10 box-border max-w-full">
          <SolutionsContent />
        </section>
      </main>
      <footer className="self-stretch h-[390px] relative max-w-full text-left text-xs text-gray-200 font-desktop-body">
          ...
          <div className="self-stretch flex flex-row items-start justify-end mt-[-277px] text-xs text-gray-200 font-desktop-body">
            <div className="w-[230px] relative leading-[150%] inline-block shrink-0 box-border pl-5 z-[1]">
              ...
              <p className="m-0">
                <span>
                  <span>
                    443, Anna Salai Teynampet, Chennai,  Tamil Nadu 600018,
                    India
                  </span>
                </span>
              </p>
